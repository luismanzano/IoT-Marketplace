...
def on_connect(client,userdata,flags,rc):
	print('Conectado entrada 2')
	client.subscribe(topic='tienda/entrada2', qos=2)

def susEntrada1():
	client = paho.mqtt.client.Client(client_id='entrada2', clean_session=False)
...
def ejecutarSalida(aux):
    ...
    item_tuple = (aux['cedula'], 2, aux['hora_salida'])
    cursor.execute(insert_query, item_tuple)
    connection.commit()
